...
$lng['serversettings']['letsencrypt_email']['title'] = 'Contact email for Let\'s Encrypt';
$lng['serversettings']['letsencrypt_email']['description'] = 'E-mail address, which is notified when certificates expire or need to be revoked.';
